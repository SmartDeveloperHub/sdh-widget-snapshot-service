...
config.phantom.cache = true; // Enables disk cache (at desktop services cache storage location, default is false)
config.phantom.cache_limit = 5000; // Limits the size of disk cache (in KB) per worker
